...
Certain terms of employment and procedures that apply to faculty members are contained in \autoref{sec:ContractualStatement}.

\vspace{3in}
To obtain the most recent version of this document see \autoref{sec:CurrentVersion}.
}
...
\lhead{Faculty Handbook, Version: Beta Release Candidate}
\rhead{Typeset: \DTMnow~Earth}
\cfoot{\thepage}
...
\donNote{ I want to change all the "his" "his or her" to "their"}
...
\section{HISTORY, MISSION, GENERAL ORGANIZATION AND GOVERNANCE}
	\subsection{History}
		...
		\donNote{Can we use Ruth Kerr's actual name? "founded by Mrs. Ruth Kerr"}
		...
		Noticias: Journal of the Santa Barbara Historical Museum, Vol LIV, No. 1 written for Westmont's 75th anniversary.)
	...
	\subsection{Mission Statement}
		...
		\subsubsection{Philosophy of Education}
			...
			\donNote{These underlined things should be paragraphs like the rest of the document{\bfseries 1.2.1.1 Liberal Arts}: For example}
	...
	\subsection{College Organization}
		\subsubsection{Board of Trustees}
			\begin{enumerate}
				...
				\item{
					It is essential that trustees be persons of genuine Christian faith, who accept without reservation the Articles of Faith, and seek to uphold the college motto on the corporate seal, Christus Primatum Tenens (``Christ holding Preeminence'').
					\donNote{capitalization}
				}
		...
		\subsubsection{Administration}
			\begin{enumerate}
				...
				\donNote{where are the appendices?}
				\paragraph{President}
					\begin{enumerate}
			...
			\paragraph{Executive Team}
				...
				\subparagraph{Provost}
					...
					\begin{enumerate}
						...
						\item{\underline{Responsibilities and Duties}:
							\donNote{Original numbering was off - started at 4}
							\begin{enumerate}
...
\section{About this document}
	\begin{wrapfigure}{h}[0cm]{0.3\textwidth}
		\centering
		\vspace{-30pt}
		\fbox{\includegraphics[width=2in]{images/qr_code_github_repo.png}}
	...
	\subsection{Current Version}
		...
		\begin{wrapfigure}{h}[0cm]{0.3\textwidth}
			\centering
			\vspace{-30pt}
			\fbox{\includegraphics[width=2in]{images/qr_code_current_release.png}}
