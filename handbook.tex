...
%https://tex.stackexchange.com/a/60212/149539
\usepackage{titlesec}
...
\newcommand{\donNote}[1]{\note{#1 \hfill {\bfseries djp3}}{0.5mm}}
...
\item{
The Westmont College Board of Trustees holds in trust the physical and financial
assets of the College and has power of review and veto in relation to policy and
programs.
}
\item{
...
\subsubsubsection{President}
\begin{enumerate}[label=\alph*)]

\item{Function: To serve as chief executive officer of the College and to exercise all executive powers not explicitly reserved to the Trustees.
}
\item{Term: Appointed annually by the Board of Trustees.
}
\item{Accountability: Accountable directly to the Board of Trustees.
}
\item{Salary: Remunerated as recommended and approved by the Board of Trustees.
}
...
(b) To seek support for the College necessary to achieve the institutionÕs
mission and goals.}
\end{enumerate}
