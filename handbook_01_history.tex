\section{HISTORY, MISSION, GENERAL ORGANIZATION
	...
	\subsection{History}
		...
		written for Westmont's 75th anniversary~\cite{Phinney2012}\change{.}{23}{improved citation formatting})
			...
			\paragraph{Executive Team}
				...
				\subparagraph{Provost}
					...
					\begin{enumerate}
						...
						\item{\underline{Responsibilities and Duties}\change{:}{23}{9/2020 numbering started at 4}
							\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item{\underline{Responsibilities and Duties}:
							\begin{enumerate}
								...
								\item{Oversee and implement probational faculty development procedures as outlined in the Faculty Handbook, \ref{sec:PromotionEvaluationProcedure}.}
	...
	\subsection{Committee Structure and Responsibilities}
		...
		\subsubsection{Committees of the Faculty}
			...
			(\change{error}{23}{original reference referenced the wrong name})
					...
					\item{Procedures
						...
						\begin{enumerate}[label=\arabic*)]
							...
							\item{
								...
								Meetings will be governed by Robert's Rules of Order, Newly Revised, 9th ed (1990).}
			...
			\paragraph{Curricular}
				...
				\subparagraph{Academic Senate:  Review Committee}
					\begin{enumerate}[label=\alph*)]
						\item{\underline{Membership}:\change{format inconsistency}{23}{9/2020 numbering started at 4}
							\begin{enumerate}[label=\arabic*)]
			...
			\paragraph{Administrative}
						...
						\item{\underline{Responsibilities}:
							\begin{enumerate}[label=\arabic*)]
								...
								\item{To establish the schedule of regular faculty meetings as stipulated in
									\ref{sec:FacultyMeetings}
									, and to call special faculty meetings as necessary.}
				...
				\subparagraph{  Faculty Budget and Salary Committee}
					\begin{enumerate}[label=\alph*)]
						\item{\underline{Membership}: \change{format inconsistency}{23}{9/2020 was inconsistent with underlining}
							\begin{enumerate}[label=\arabic*)]
								\item{Provost (or representative)}
			...
			\paragraph{Institutional}
				...
				\subparagraph{Student Life Committee}
					\begin{enumerate}[label=\alph*)]
						\item{\underline{Membership}: \change{Original label was wrong }{23}{9/2020 was inconsistent with underlining}
							\begin{enumerate}[label=\arabic*)]
								\item{Provost (or representative)}
								\item{Vice President for Student Life (or representative)}
					...
					\begin{enumerate}[label=\alph*)]
						...
						\item{\underline{Responsibilities}:
							\begin{enumerate}[label=\arabic*)]
								...
								\item{To review cases when progressive discipline (See \ref{sec:Discipline}) is invoked and to recommend the nature of sanctions if applicable.}
							\end{enumerate}
						}
					\end{enumerate}
			...
			\paragraph{Committee Release}
				...
				\begin{enumerate}[label=\alph*)]
					...
					\item{\underline{Application Procedure}: \change{format inconsistency}{23}{9/2020 was inconsistent with colon}
						\begin{enumerate}[label=\arabic*)]
